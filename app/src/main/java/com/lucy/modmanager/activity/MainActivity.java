package com.lucy.modmanager.activity;
...
import com.lucy.modmanager.BuildConfig;
import com.lucy.modmanager.Constants;
import com.lucy.modmanager.R;
import com.lucy.modmanager.databinding.MainActivityBinding;
import com.lucy.modmanager.fragment.SettingsFragment;
import com.lucy.modmanager.preference.IActivityResultPreference;
...
public class MainActivity extends BaseActivity<MainActivityBinding> {
    ...
    private class PackageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView packageNameView = convertView.findViewById(R.id.app_package);
            iconView.setImageDrawable(packageInfoList.get(position).applicationInfo.loadIcon(getPackageManager()));
